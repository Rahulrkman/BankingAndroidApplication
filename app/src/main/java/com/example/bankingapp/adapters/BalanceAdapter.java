...
public class BalanceAdapter extends RecyclerView.Adapter<BalanceAdapter.MyViewHolder> {
    ...
    public BalanceAdapter(Context context, ArrayList<String> phoneNo, ArrayList<String> name, ArrayList<String> balance, ArrayList<String> email) {
    ...
    public BalanceAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.balance, parent, false);
